  ...
  return (
    ...
    >
      ...
      <section className="pt-40 pb-20 border-b border-border bg-card relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(225,230,240,0.05)_0%,transparent_50%)] pointer-events-none" />
            ...
            >
              <div className="bg-card border border-border p-10 md:p-16 relative overflow-hidden">
                ...
                <form className="space-y-10 relative z-10" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="pt-4">
                    <Button type="submit" className="w-full rounded-none bg-primary text-primary-foreground hover:bg-primary/90 h-16 text-sm font-mono uppercase tracking-widest border border-primary hover:shadow-[0_0_30px_rgba(225,230,240,0.4)] transition-all group overflow-hidden relative">
