        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3 group relative z-50 cursor-none">
              ...
              <div className="w-2 h-2 rounded-full bg-primary animate-pulse shadow-[0_0_10px_rgba(225,230,240,0.8)]" />
            </Link>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="flex items-center gap-4 border-l border-border/50 pl-8">
                ...
                <Link href="/contact" className="cursor-none">
                  <Button className="rounded-none bg-primary/10 text-primary border border-primary/30 hover:bg-primary hover:text-primary-foreground hover:shadow-[0_0_20px_rgba(225,230,240,0.4)] transition-all duration-300 relative overflow-hidden group cursor-none">
